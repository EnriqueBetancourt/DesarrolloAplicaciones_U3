...
public class configurarFragment extends Fragment
    ...
    public void onGesturePerformed(GestureOverlayView gestureOverlayView, Gesture gesture) {
        ...
        if (predictions.size() > 0 && predictions.size() > 1.0){
            ...
            if(action.equals("salir")){
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT, "Asunto: Correo a mi mismo");
                intent.putExtra(Intent.EXTRA_TEXT, "Texto del correo: Hola");
                intent.putExtra(Intent.EXTRA_EMAIL, new String[]
                        {"lbetancourt894@gmail.com"});
